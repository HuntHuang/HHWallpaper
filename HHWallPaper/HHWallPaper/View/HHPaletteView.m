...
- (void)layoutSubviews
{
    ...
    HHButton *sureBtn = [[HHButton alloc] initWithFrame:CGRectMake(self.width - 60, 0, 50, 50)];
    ...
    HHButton *closeBtn = [[HHButton alloc] initWithFrame:CGRectMake(5, 0, 50, 50)];
    ...
    [UIView animateWithDuration:0.5 animations:^{
        [weakSelf positionAtY:IPhoneHeight-300];
    }];
}
